...
export const TESTNET_PARAMS = {
    chainId: '31338', // Hardhat's default chain ID
    chainName: 'Hardhat Local Network_2',
    rpcUrls: ['https://indian-updated-june-shareholders.trycloudflare.com'], // Hardhat's default RPC URL
    nativeCurrency: {
      name: 'ETH2',
      symbol: 'ETH2',
      decimals: 18,
